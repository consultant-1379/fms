/*
 * * @file fms_cpf_oi_compositesubfile.h
 *	@brief
 *	Header file for FMS_CPF_OI_CompositeSubFile class.
 *  This module contains the declaration of the class FMS_CPF_OI_CompositeSubFile.
 *
 ...
 *	+========+============+==============+=====================================+
 *	| 1.0.0  | 2011-07-13 | qvincon      | File created.                       |
 *	+========+============+==============+=====================================+
 */
...
==================================================================== */
#ifndef FMS_CPF_OI_COMPOSITESUBFILE_H_
#define FMS_CPF_OI_COMPOSITESUBFILE_H_
...
=================================================================== */
class FMS_CPF_OI_CompositeSubFile : public FMS_CPF_OI_BaseObject, public acs_apgcc_objectimplementerinterface_V3
{
 public:

		/**		@brief	constructor of FMS_CPF_OI_CompositeSubFile class
		*/
		FMS_CPF_OI_CompositeSubFile(FMS_CPF_CmdHandler* cmdHandler);

		/**		@brief	destructor of FMS_CPF_OI_CompositeSubFile class
		*/
		virtual ~FMS_CPF_OI_CompositeSubFile();
		/** @brief create method
		 *
		 *	This method will be called as a callback when an Object is created as instance of a Class CompositeSubFile
		 ...
		 *
		 *	This method will be called as a callback when deleting a CompositeSubFile Object
		...
		/** @brief modify method
		 *
		 *	This method will be called as a callback when modifying a CompositeSubFile Object
		 *	All input parameters are input provided by IMMSV Application and have to be used by the implementer to perform
		 *	proper actions.
		 *
		 *  @param oiHandle: the object implementer handle. This is an Input Parameter provided by IMMSV Application.
		 ...
		 *	regarding a CompositeSubFile Object
		 *
		 *  @param oiHandle: the object implementer handle. This is an Input Parameter provided by IMMSV Application.
		 *
		 *	@param ccbId: the ID for the Configuration Change Bundle in which the modify of the Object is contained.
		...
		/** @brief abort method
		 *
		 *	This method will be called as a callback when a Configuration Change Bundle, regarding a CompositeSubFile Object,
		...
		/** @brief apply method
		 *
		 *	This method will be called as a callback when a Configuration Change Bundle, regarding a CompositeSubFile Object, is complete and can be applied.
	 ...
	 private:
		...
		/** @brief	compositeSubFileInfo
		 *
		 *  Struct of IMM compositeSubFileInfo class elements
		 *
		 */
		struct compositeSubFileInfo{
				...
				std::string newSubFileNameValue;
		};

		typedef std::multimap<ACS_APGCC_CcbId, compositeSubFileInfo> operationTable;

		/** @brief	m_compositeSubFileOperationTable
		 *
		 *  Map of pending CompositeSubFile Operations
		 *
		 */
		operationTable m_compositeSubFileOperationTable;

		/**		@brief	fms_cpf_oi_compSubFileTrace
		*/
		ACS_TRA_trace* fms_cpf_oi_compSubFileTrace;


};

#endif /* FMS_CPF_OI_COMPOSITESUBFILE_H_ */
