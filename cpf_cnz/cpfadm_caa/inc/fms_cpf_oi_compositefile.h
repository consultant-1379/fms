 ...
 *	@brief
 *	Header file for FMS_CPF_OI_CompositeFile class.
 *  This module contains the declaration of the class FMS_CPF_OI_CompositeFile.
 *
...
#ifndef FMS_CPF_OI_COMPOSITEFILE_H_
#define FMS_CPF_OI_COMPOSITEFILE_H_
...
=================================================================== */
class FMS_CPF_OI_CompositeFile : public FMS_CPF_OI_BaseObject, public acs_apgcc_objectimplementerinterface_V3
{
 public:

		/**		@brief	constructor of FMS_CPF_OI_CompositeFile class
		*/
		FMS_CPF_OI_CompositeFile(FMS_CPF_CmdHandler* cmdHandler);

		/**		@brief	destructor of FMS_CPF_OI_CompositeFile class
		*/
		virtual ~FMS_CPF_OI_CompositeFile();

		/** @brief create method
		 *
		 *	This method will be called as a callback when an Object is created as instance of a Class CompositeFile
		 ...
		 *
		 *	This method will be called as a callback when deleting a CompositeFile Object
		...
		/** @brief modify method
		 *
		 *	This method will be called as a callback when modifying a CompositeFile Object
		 *	All input parameters are input provided by IMMSV Application and have to be used by the implementer to perform
		 *	proper actions.
		 *
		 *  @param oiHandle: the object implementer handle. This is an Input Parameter provided by IMMSV Application.
		 ...
		 *	regarding a CompositeFile Object
		 *
		 *  @param oiHandle: the object implementer handle. This is an Input Parameter provided by IMMSV Application.
		 *
		 *	@param ccbId: the ID for the Configuration Change Bundle in which the modify of the Object is contained.
		...
		/** @brief abort method
		 *
		 *	This method will be called as a callback when a Configuration Change Bundle, regarding a CompositeFile Object,
		...
		/** @brief apply method
		 *
		 *	This method will be called as a callback when a Configuration Change Bundle, regarding a CompositeFile Object, is complete and can be applied.
		...
		void isMulticp(bool status) { m_isMultiCP = status;};
 ...
 private:
		 ...
		 *
		 *  Struct of IMM compositeFileInfo class elements
		 *
		 */
		struct compositeFileInfo{
				std::string cpName;
		...
		typedef std::multimap<ACS_APGCC_CcbId, compositeFileInfo> operationTable;

		/** @brief	m_compositeFileOperationTable
		 *
		 *  Map of pending CompositeFile Operations
		 *
		 */
		operationTable m_compositeFileOperationTable;

		/**		@brief	fms_cpf_oi_compFileTrace
		*/
		ACS_TRA_trace* fms_cpf_oi_compFileTrace;
		
		bool m_isMultiCP;

};

#endif /* FMS_CPF_OI_COMPOSITEFILE_H_ */
