...
#ifndef FMS_CPF_WRITENEXTCPMSG_H
#define FMS_CPF_WRITENEXTCPMSG_H

#include "fms_cpf_cpmsg.h"

#include <ace/RW_Thread_Mutex.h>

class FMS_CPF_WritenextCPMsg : public FMS_CPF_CPMsg
{
public:

  FMS_CPF_WritenextCPMsg(const char* aInBuffer, unsigned int aInBufferSize, FMS_CPF_CpChannel* CPChan);
  virtual ~FMS_CPF_WritenextCPMsg();
...
private:
  ...
  // Out parameters
  unsigned long	lastRecordWritten;
  ACS_TRA_trace* fms_cpf_WritenextCPMsg;
